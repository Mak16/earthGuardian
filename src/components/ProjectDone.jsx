...
export default function ProjectDone() {
  ...
  return (
    <div className="flex flex-col w-[90%] lg:w-[90%] mx-auto space-y-16">
      <div className="lg:w-3/6 mx-auto w-full flex lg:flex-row flex-col lg:space-x-5 space-x-0">
        <div className="lg:space-y-6 space-y-6">
          <h2 className="font-roboto text-lg text-center text-[#1D2130]">
            PROJETS RÉALISÉS
          </h2>
          <p className="font-roboto lg:text-5xl text-2xl text-center font-medium">
            Nous créons une société durable, pour tous.
          </p>
        </div>
      </div>
